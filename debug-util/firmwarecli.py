...
class FirmwareCli:
    ...
    def _bootmode(self):
        ...
        self.proc.expect('Hit \^d to stop autoboot:')
    ...
    def _sendfile(self, filename):
        ...
        self.sport.close()
        self.sport = serial.Serial(port=tty, baudrate=self.baudrate, bytesize=8, parity='N', stopbits=1, timeout=None, xonxoff=0, rtscts=0)
    ...
    def identifydevice(self):
        """ Attempt to determine version a productid of a device. """
        self._appmode()
